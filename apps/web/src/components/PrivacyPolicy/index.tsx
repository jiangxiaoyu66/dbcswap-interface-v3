  ...
  },
  {
    ...
    description: (
      <>
        ...
        <ExternalLink href="https://support.ubeswap.org/hc/en-us/articles/8671777747597-Address-Screening-Guide">
    ...
    >
      <AutoColumn gap="16px">
        <AutoColumn gap="sm" style={{ width: '100%' }}>
          <StyledExternalCard>
            <ExternalLink href="https://ubeswap.org/terms-of-service">
              <RowBetween>
                <AutoRow gap="4px">
                  <Info size={20} />

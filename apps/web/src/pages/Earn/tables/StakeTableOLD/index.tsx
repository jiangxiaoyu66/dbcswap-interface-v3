...
import { useEarnParams } from 'pages/Earn/redirects'
...
export function StakeTable() {
  const chainName = validateUrlChainParam(useEarnParams().chainName)
...
function TokenTable({
  ...
  const tokenTableValues: TokenTableValue[] | undefined = useMemo(
    ...
    [chainId, filterString, sparklines, timePeriod, tokenSortRank, tokens]
  )
